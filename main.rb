puts "Whats the path to the .app? (ex:/Applications/Pages.app)"
...
# basically this whole app just calls this command on a bunch of files/folders
def sign(filepath)
    if @show_or_run =~ /run/
...
puts "running main resigning command:"
...
for each_name in list_of_frameworks
    # its a framework, lets resign it
    ...
    # if it is a dynamic library it also needs resigning 
